...
<form class="site" method="POST" action="<?php echo base_url();?>home/acc_owner_login">
            ...
            <div class="col-12">
               <div class="d-flex align-items-center justify-content-center flex-column flex-lg-row">
                  ...
                  <a type="link" href="<?php echo base_url();?>home/forgetpass" title="" class="btn btn--outline order-2 order-lg">
                     <span class="btn__sign"></span><span class="btn__text" style="color: #004ab2;">Reset Password</span>
                  </a>
               </div>
            </div>
            <div class="col-12">
               <p class="d-flex align-items-center justify-content-center flex-column flex-lg-row"><span>Don't have an account?</span><a class="order-2 order-lg mb-0 ml-3" href="<?php echo base_url();?>home/accsignup">Sign up here</a></p>
            </div>
         </div>
      </div>
   </div>
