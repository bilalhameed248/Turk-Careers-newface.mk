        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            <h3 class="card-title">Payment details for Accademy Owners</h3>
                        </div>
                        <div class="col-sm-8">
                            <form method="post" action="<?php echo base_url().'admin/finance/searchAoByDate'?>" >
                                <div class="row">
                                    <div class="col-sm-2">
                            ...
                            <div class="col-sm-6">
                                <?php
                                $total=0;
                                foreach($payments as $accademy_owner)
                                { 
                                    $total=$total+$accademy_owner->payment;
                                }?>
                    ...
                    <table class="table table-striped projects">
                        ...
                        foreach($payments as $accademy_owner)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $accademy_owner->acc_owner_name; ?>
                                </td>
                                <td>
                                    <?php echo $accademy_owner->acc_email; ?>
                                </td>
                                <td>
                                    <?php echo $accademy_owner->phone_number; ?>
                                </td>
                                <td>
                                    <?php 
                                        $date= $accademy_owner->date;
                                        echo date('d-F-Y', strtotime($date)); //June, 2017
                                    ?>
                                </td>
                                <td class="project_progress">
                                    <?php echo $accademy_owner->payment; ?>
                                </td>
                            </tr>
                            <?php
                            $i++;
