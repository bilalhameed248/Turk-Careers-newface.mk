...
<div class="content-wrapper">
    ...
    <br><br>
            <div class="card-body p-0">
                <form method="post" action="<?php echo base_url();?>admin/settings/update_pricing/<?php echo $pricing->id;?>/cand">
                    <div class="row">
                        <br><br><div class="col">
...
<!--                        </div>-->
                        <div class="col">
                            <label class="" for="">desc</label>
                            <input type="text" class="form-control" placeholder="price" value="<?php echo $pricing->desc;?>" name="price">
                        </div>
                    </div><br><br>
                    <div class="row">
