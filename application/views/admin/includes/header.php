    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url().'admin/home/logout'?>">
                  logout
              </a>
          </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url();?>public/admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Newfaceskills</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>admin/candidate" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>admin/academy" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All</p>
                </a>
              </li>
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>admin/settings/pricing/cand" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Candidates</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>admin/settings/pricing/emp" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Employees</p>
                        </a>
                    </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>admin/finance/job_owner" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Job Owner</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>admin/finance/accademy_owner" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Accademy Owner</p>
                </a>
              </li>
...
<!--          <li class="nav-item">-->
<!--            <a href="--><?php //echo base_url();?><!--admin/settings/pricing" class="nav-link">-->
<!--              <i class="nav-icon far fa-image"></i>-->
<!--              <p>-->
<!--                Pricing plans-->
<!--              </p>-->
