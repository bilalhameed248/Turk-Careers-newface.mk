...
<form class="site" method="POST" action="<?php echo base_url();?>markiting/markiting_signin">
      ...
      <div class="container--full-width-column container--full-width-padded container">
         <div class="justify-content-center text-center mg-b-xs-12 row">
            <div class="col-12 col-md-8">
               <h2 class="mg-b-xs-2">Marketer Login via Email &amp; Password</h2>
            </div>
         </div>
         ...
         <div class="row">
            ...
            <div class="col-12">
               <p class="d-flex align-items-center justify-content-center flex-column flex-lg-row"><span>Don't have an account?</span><a class="order-2 order-lg mb-0 ml-3" href="<?php echo base_url();?>markiting/markiting_signup">Sign up here</a></p>
            </div>
         </div>
      </div>
   </div>
