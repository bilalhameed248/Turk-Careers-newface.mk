                ...
                <div class="central-meta">
                  <div class="job-search-form">
                    <div class="jobbox-title">
                      ...
                      <h5>Looking for a job</h5> <?php }else{ ?>
                    ...
                    <form method="post" class="c-form">
                      <div class="row merged10" style="position:relative; left: 18%;">
                        <div class="col-lg-2 col-md-3">
                          <span class="add-loc">
                            <input type="text" placeholder="location" id="location" onkeyup="filterjobs();">
                        ...
                        <div class="col-lg-4 col-md-9">
                          <input type="text" placeholder="title/Description" id="title" onkeyup="filterjobs()">
                        </div>
...
<script type="text/javascript">
  ...
  <?php include('timeline/include/footer.php'); ?>