...
<!-- Mirrored from wpkixx.com/html/pitnik/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jan 2021 12:25:47 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="" />
    <meta name="keywords" content="" />
<title>Academy Owner</title>
    <link rel="icon" href="images/fav.png" type="image/png" sizes="16x16">
   
    <link rel="icon" href="<?php echo base_url();?>public/timeline2/images/fav.png" type="image/png" sizes="16x16">
   
    <link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/main.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/weather-icons.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/toast-notification.css">
<link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/page-tour.css">
    <link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/color.css">
    <link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/responsive.css">
    <link rel="stylesheet" href="<?php echo base_url();?>public/timeline2/css/eventCalendar.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="//code.jquery.com/jquery.min.js"></script>
<script src="<?php echo base_url();?>public/image_layout_plugin/src/images-grid.js"></script>
<link rel="stylesheet" href="<?php echo base_url();?>public/image_layout_plugin/src/images-grid.css">
...
<li><a href="<?php echo base_url().'home/acc_owner_logout' ?>" title=""><i class="ti-power-off"></i>log out</a></li>
</ul>
</div>
</div>
...
<i class="ti-menu"></i>
    ...
    <li>
    <a href="<?php echo base_url().'Accademy_owner/index'?>" title="Home" data-toggle="tooltip" data-placement="right">
    <i class="fa fa-star-o"></i>
    </a>
    </li>
    <li>
    <a href="<?php echo base_url().'Accademy_owner/get_all_academies'?>" title="Add New Accademy" data-toggle="modal" data-target="#myModal" data-placement="right">
    <i class="ti-magnet"></i>
    </a>
    </li>
    <li>
    <a href="<?php echo base_url().'Accademy_owner/index'?>" title="My Academies" data-toggle="tooltip" data-placement="right">
    <i class="fa fa-forumbee"></i>
    </a>
    </li>
    <li>
    <a href="<?php echo base_url().'Accademy_owner/get_all_academies'?>" title="View All Academies" data-toggle="tooltip" data-placement="right">
    <i class="ti-user"></i>
    </a>
    </li>
...
<li><a class="" href="#" title="" data-toggle="modal" data-target="#myModal"><i class="fa fa-home" ></i>Add New Academy</a>

</li>
<li><a class="" href="<?php echo base_url().'Accademy_owner/index' ?>" title=""><i class="fa fa-film"></i>My Academies</a>

</li>
<li>
    <a class="" href="<?php echo base_url().'Accademy_owner/get_all_academies' ?>" title="">
        <i class="fa fa-female"></i>View All Academies
    </a>
...
<section>
    <div class="gap2 gray-bg">
        ...
        <div class="col-lg-12">
            <?php if(!$academies) { ?>
                <li>
                    <button class="btn btn-primary btn-lg btn-block" href="#" title="" data-toggle="modal" data-target="#myModal">No Accademy Found Ckick Here To Add New Academy
                    </button>
                </li>
            <?php } ?>
            <?php foreach($academies as $academy1) { ?>
                <div class="central-meta searched">
                    <div class="user-post job">
                        <div class="friend-info">
                            <figure>
                            <img src="<?php echo base_url().$academy1['academy_logo'];?>" alt="">
                            </figure>
                            <div class="friend-name">
                            <ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="#" title=""><?php echo $academy1['academy_name'];?></a></ins>
                            <br>
                            ...
                            <div class="post-meta">
                            <h6><a href="career-detail.html" title=""><?php echo $academy1['academy_address'];?></a></h6>
                                <div class="description">
                                <p>
                                <?php echo $academy1['academy_desc'];?>
                                </p>
                                </div>
                                <div class="rate-n-apply">
                                    ...
                                    <a href="#" title="" class="main-btn" data-ripple="">Visit Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Register New Academy</h4>
                    </div>
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>accademy_owner/insert_academy">
                          <div class="form-group">
                            <label for="jobname">Academy Name</label>
                            <input required type="text" name="academy_name" class="form-control" id="academy_name" aria-describedby="emailHelp" placeholder="Enter Academy name">
                           
                          </div>
                          <div class="form-group">
                            <label for="description">Academy Description</label>
                            <textarea required cols="5" placeholder="Enter Academy Description" rows="5" name="academy_description"></textarea>
                          </div>

                          <div class="form-group">
                            <label for="salary">Academy Address</label><br>
                            <div>
                              <input required type="text" name="academy_address" class="form-control" value=""  placeholder="Enter Address" />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="salary">Academy Website URL</label><br>
                            <div>
                              <input required type="text" name="academy_website_url" class="form-control" value=""  placeholder="Enter Academy Website URL" />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="salary">Academy logo</label>
                            <input  type="file"  name="academy_logo"  accept="image/x-png,image/gif,image/jpeg" >
                          </div>
...
<!-- Mirrored from wpkixx.com/html/pitnik/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jan 2021 12:25:50 GMT -->
</html>
