...
<li><a class="" href="#" title=""><i class="fa fa-film"></i>My Academies</a>
                ...
                <div class="central-meta searched">
                    <div class="user-post job">
                        <div class="friend-info">
                            ...
                            <ins><em class="verify"><i class="fa fa-check-circle"></i></em> <a href="time-line.html" title=""><?php echo $academy1['academy_name'];?></a></ins>
                            <br>
                            ...
                            <h6><a href="career-detail.html" title=""><?php echo $academy1['academy_address'];?></a></h6>
                                ...
                                <div class="rate-n-apply">
                                    ...
                                    <a href="career-detail.html" title="" class="main-btn" data-ripple="">Visit Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>accademy_owner/insert_academy">
                          ...
                          <div class="form-group">
                            ...
                            <input required accept="image/x-png,image/gif,image/jpeg" name="academy_logo" required type="file">
                          </div>
                          <!-- <div class="form-group">
